...
export default {
  ...
  pages_check: {
    ...
    "/pages/package_my/card/card": {
      weixin_token: true,
      ucenter: true
    },
    "/pages/package_my/card/info": {
      weixin_token: true,
      ucenter: true
    },
    "/pages/index/index": {
    ...
    "/pages/adviser/businesscard": {
      weixin_token: true
    },
    "/pages/adviser/adviser": {
      weixin_token: true,
    },
    "/pages/layout/detail": {
      weixin_token: true
    },
    "/pages/package_my/lottery/lottery": {
      weixin_token: true,
      ucenter: true
    },
    "/pages/my/my": {
    ...
    "/pages/redpack/redpack": {
      weixin_token: true
    },
    "/pages/helphand/helphand": {
      weixin_token: true
    },
    "/pages/news/news_info": {
      weixin_token: true
    ...
    "/pages/package_my/ticket/ticket": {
      weixin_token: true
    },
    ...
    "/pages/utils/userauth": {
      ext: false,
      setting: false
    },
    "/pages/vr_room/package/room/room": {
      weixin_token: true
    },
    "/pages/vr_room/package/authorize/authorize": {
      weixin_token: true
    },
